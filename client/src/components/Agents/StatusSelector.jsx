  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        ...
        className="border border-gray-200 rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition-shadow"
      >
        {statuses.map((s) => (
