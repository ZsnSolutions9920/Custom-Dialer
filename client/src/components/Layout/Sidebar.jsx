...
export default function Sidebar({ open, onClose, darkMode, onToggleDarkMode }) {
  ...
  return (
    <aside
      className={`
        fixed inset-y-0 left-0 z-50 w-[220px] bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col
    ...
    >
      ...
      <div className="px-4 py-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <p className="text-xs text-gray-400 dark:text-gray-500 mt-2 truncate">{agent?.displayName}</p>
      </div>
      ...
      <div className="px-4 py-3 border-t border-gray-200 dark:border-gray-700 space-y-2">
        ...
        <button
          onClick={logout}
          className="w-full px-2 py-1.5 text-[13px] text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md text-left transition-colors"
        >
          Sign Out
        </button>
      </div>
