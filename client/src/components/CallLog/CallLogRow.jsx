        ...
        <td className="px-4 py-3 text-sm">
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-medium text-gray-500 hover:bg-gray-100 transition-colors"
            ...
            {call.disposition && (
              <span className={`inline-block px-2 py-0.5 rounded text-xs ${DISPOSITION_COLORS[call.disposition] || 'bg-gray-100 text-gray-600'}`}>
                {call.disposition}
              </span>
            )}
          </div>
