// US/Canadian area code → IANA timezone mapping
const AREA_CODE_TZ = {
  // Eastern Time
  ...
  '270': 'America/New_York', '272': 'America/New_York', '276': 'America/New_York',
  '278': 'America/New_York', '281': 'America/Chicago', '283': 'America/New_York',
  ...
  '327': 'America/Chicago', '330': 'America/New_York', '331': 'America/Chicago',
  '332': 'America/New_York', '334': 'America/Chicago', '336': 'America/New_York',
  '337': 'America/Chicago', '339': 'America/New_York', '340': 'America/Virgin',
  ...
  '445': 'America/New_York', '458': 'America/Los_Angeles', '463': 'America/New_York',
  ...
  '563': 'America/Chicago', '564': 'America/Los_Angeles', '567': 'America/New_York',
  ...
  '689': 'America/New_York', '701': 'America/Chicago', '702': 'America/Los_Angeles',
  ...
  '731': 'America/Chicago', '732': 'America/New_York', '734': 'America/New_York',
  '737': 'America/Chicago', '740': 'America/New_York', '743': 'America/New_York',
  ...
  '817': 'America/Chicago', '818': 'America/Los_Angeles', '820': 'America/New_York',
  '828': 'America/New_York', '830': 'America/Chicago', '831': 'America/Los_Angeles',
  '832': 'America/Chicago', '835': 'America/New_York', '838': 'America/New_York',
  ...
  '928': 'America/Phoenix', '929': 'America/New_York', '930': 'America/New_York',
  '931': 'America/Chicago', '934': 'America/New_York', '936': 'America/Chicago',
  '937': 'America/New_York', '938': 'America/Chicago', '940': 'America/Chicago',
  ...
  '986': 'America/Denver', '989': 'America/New_York',
...
/**
 * Extract timezone info for a US phone number based on its area code.
 * @param {string} phoneNumber - The phone number (any format)
 * @returns {{ timezone: string, label: string, localTime: string } | null}
 */
export function getTimezoneForNumber(phoneNumber) {
  ...
  // Need at least 3 digits for area code
  if (normalized.length < 3) return null;

  const areaCode = normalized.slice(0, 3);
  const timezone = AREA_CODE_TZ[areaCode];
